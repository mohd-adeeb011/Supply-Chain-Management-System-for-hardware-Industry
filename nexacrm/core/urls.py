...
urlpatterns = [
    ...
    path('delete_inventory_item/<int:item_id>/', views.delete_inventory_item_view, name='delete_inventory_item'),
    ...
    path('order_item_from_cart/<int:cart_item_id>/', views.order_item_from_cart_view, name='order_item_from_cart'),
    ...
    path('sold_products/', views.sold_products_view, name='sold_products'),
